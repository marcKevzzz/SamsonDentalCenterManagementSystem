    ...
    (() => {
      ...
      class g {
        ...
        static get isReactNative() {
          return (
            !g.isNode && "object" == typeof window && void 0 === window.document
          );
        }
        static get isNode() {
          return (
      ...
      class U {
        ...
        subscribe(t) {
          return (this.observers.push(t), new b(this, t));
        }
      }
      class L {
        constructor(t, e, s) {
      ...
      class q {
        ...
        St() {
          if (
            ...
            if (t < 0) return void (this.ut === A.Connected && this.Ft());
            void 0 === this.Bt &&
              (t < 0 && (t = 0),
              (this.Bt = setTimeout(async () => {
                this.ut === A.Connected && (await this.Ft());
              }, t)));
          }
        }
        serverTimeout() {
        ...
        async Wt(t) {
          ...
          c
            ...
            : r
              ? (h
                  ? (c = this.Xt(t.invocationId, `${h}`, null))
                  : void 0 !== o
                    ? (c = this.Xt(t.invocationId, null, o))
                    : (this.u.log(
                        e.Warning,
                        `No result given for '${s}' method and invocation ID '${t.invocationId}'.`,
                      ),
        ...
        async zt(t) {
          ...
          for (; null !== r; ) {
            if (
              (this.u.log(
                e.Information,
                `Reconnect attempt number ${i + 1} will start in ${r} ms.`,
              ),
              await new Promise((t) => {
        ...
        Tt() {
          this.Bt && (clearTimeout(this.Bt), (this.Bt = void 0));
        }
        Ct() {
                  ...
                  ((i =
                    t instanceof Error
                      ...
                      : t && t.toString
                        ? t.toString()
                        : "Unknown error"),
                    (e = e.then(() => this.xt(this.Xt(s, i)))));
                },
                next: (t) => {
                  e = e.then(() => this.xt(this.Kt(s, t)));
                },
              });
          }
        }
      ...
      class j {
        constructor(t) {
          this.Qt = void 0 !== t ? [...t, null] : M;
        }
        nextRetryDelayInMilliseconds(t) {
          return this.Qt[t.previousRetryCount];
        }
      }
      class W {}
      ...
      class O extends d {
        constructor(t, e) {
          (super(), (this.Yt = t), (this.Zt = e));
        }
        async send(t) {
          let e = !0;
          (this.Zt &&
            (!this.te || (t.url && t.url.indexOf("/negotiate?") > 0)) &&
            ((e = !1), (this.te = await this.Zt())),
            this.ee(t));
          const s = await this.Yt.send(t);
          return e && 401 === s.statusCode && this.Zt
            ? ((this.te = await this.Zt()), this.ee(t), await this.Yt.send(t))
            : s;
        }
        ee(t) {
          (t.headers || (t.headers = {}),
            this.te
              ? (t.headers[W.Authorization] = `Bearer ${this.te}`)
              : this.Zt &&
                t.headers[W.Authorization] &&
                delete t.headers[W.Authorization]);
        }
        getCookieString(t) {
          return this.Yt.getCookieString(t);
        }
      }
      var F, B;
      (!(function (t) {
      ...
      class X {
        ...
        abort() {
          this.se || ((this.se = !0), this.onabort && this.onabort());
        }
        get signal() {
          return this;
        }
      ...
      class J {
        ...
        async connect(t, s) {
          ...
          const [n, r] = $(),
            o = { [n]: r, ...this.ne.headers },
            h = {
              abortSignal: this.ie.signal,
              headers: o,
              timeout: 1e5,
              withCredentials: this.ne.withCredentials,
            };
          ...
          (200 !== a.statusCode
            ? (this.u.log(
              ...
              (this.he = new i(a.statusText || "", a.statusCode)),
              (this.re = !1))
            : (this.re = !0),
            (this.ce = this.ae(this.oe, h)));
        }
        async ae(t, s) {
          try {
            for (; this.re; )
                ...
                204 === r.statusCode
                  ...
                  : 200 !== r.statusCode
                    ? (this.u.log(
                      ...
                      (this.he = new i(r.statusText || "", r.statusCode)),
                      (this.re = !1))
                    : r.content
                      ? (this.u.log(
                          e.Trace,
                          `(LongPolling transport) data received. ${m(r.content, this.ne.logMessageContent)}.`,
                        ),
            ...
            (this.u.log(e.Trace, "(LongPolling transport) Polling complete."),
              this.pollAborted || this.le());
          }
        }
        async send(t) {
          return this.re
            ? v(this.u, "LongPolling", this.$, this.oe, t, this.ne)
            : Promise.reject(
        ...
        async stop() {
          ...
          try {
            (await this.ce,
              this.u.log(
                e.Trace,
                `(LongPolling transport) sending DELETE request to ${this.oe}.`,
              ));
            const t = {},
              [s, n] = $();
            t[s] = n;
            const r = {
              headers: { ...t, ...this.ne.headers },
              timeout: this.ne.timeout,
              withCredentials: this.ne.withCredentials,
            };
            let o;
            try {
              await this.$.delete(this.oe, r);
            } catch (t) {
              o = t;
            }
            o
        ...
        le() {
          if (this.onclose) {
            ...
            (this.he && (t += " Error: " + this.he),
              this.u.log(e.Trace, t),
              this.onclose(this.he));
          }
        }
      }
      class z {
        ...
        async connect(t, s) {
          return (
            ...
            this.te &&
              (t +=
                (t.indexOf("?") < 0 ? "?" : "&") +
                `access_token=${encodeURIComponent(this.te)}`),
            new Promise((i, n) => {
              let r,
                o = !1;
              if (s === B.Text) {
                if (g.isBrowser || g.isWebWorker)
                  r = new this.ne.EventSource(t, {
                    withCredentials: this.ne.withCredentials,
                  });
                else {
                  ...
                  ((r.onmessage = (t) => {
                    if (this.onreceive)
                      try {
                        (this.u.log(
                          e.Trace,
                          `(SSE transport) data received. ${m(t.data, this.ne.logMessageContent)}.`,
                        ),
                          this.onreceive(t.data));
                      } catch (t) {
                        return void this.ue(t);
                      }
                  }),
                    (r.onerror = (t) => {
                      o
                    ...
                    (r.onopen = () => {
                      (this.u.log(e.Information, `SSE connected to ${this.oe}`),
                        (this.de = r),
                        (o = !0),
                        i());
                    }));
        ...
        async send(t) {
          return this.de
            ? v(this.u, "SSE", this.$, this.oe, t, this.ne)
            : Promise.reject(
                new Error("Cannot send until the transport is connected"),
              );
        }
        stop() {
          return (this.ue(), Promise.resolve());
        }
        ue(t) {
          this.de &&
            (this.de.close(),
      ...
      class V {
              ...
              (o || (o = new this.pe(t)),
                ...
                (o.onmessage = (t) => {
                  if (
                    (this.u.log(
                      e.Trace,
                      `(WebSockets transport) data received. ${m(t.data, this.fe)}.`,
                    ),
                    this.onreceive)
                  )
                    try {
        ...
        send(t) {
          return this.ge && this.ge.readyState === this.pe.OPEN
            ? (this.u.log(
                e.Trace,
                `(WebSockets transport) sending data. ${m(t, this.fe)}.`,
              ),
              this.ge.send(t),
              Promise.resolve())
        ...
        stop() {
          return (this.ge && this.ue(void 0), Promise.resolve());
        }
        ue(t) {
          (this.ge &&
            ((this.ge.onclose = () => {}),
            ...
            this.onclose &&
              (!this.me(t) || (!1 !== t.wasClean && 1e3 === t.code)
                ? t instanceof Error
                  ? this.onclose(t)
                  : this.onclose()
                : this.onclose(
      ...
      class K {
        ...
        send(t) {
          return "Connected" !== this.ut
            ...
            : (this.$e || (this.$e = new G(this.transport)), this.$e.send(t));
        }
        async stop(t) {
        ...
        async yt(t) {
          let s = this.baseUrl;
          ((this.Zt = this.ne.accessTokenFactory), (this.$.Zt = this.Zt));
          try {
            if (this.ne.skipNegotiation) {
              if (this.ne.transport !== F.WebSockets)
                throw new Error(
                  "Negotiation can only be skipped when using the WebSocket transport directly.",
                );
              ((this.transport = this.ke(F.WebSockets)), await this.Pe(s, t));
            } else {
              let e = null,
                i = 0;
              do {
                ...
                if ((e.url && (s = e.url), e.accessToken)) {
                  ...
                  ((this.Zt = () => t), (this.$.te = t), (this.$.Zt = void 0));
                }
                i++;
              } while (e.url && i < 100);
              if (100 === i && e.url)
                throw new Error("Negotiate redirection limit exceeded.");
              await this.Ie(s, this.ne.transport, e, t);
            }
        ...
        async Te(t) {
          ...
          try {
            ...
            return (
              ...
              e.useStatefulReconnect && !0 !== this.ne.He
                ? Promise.reject(
                    new a(
        ...
        async Ie(t, s, i, n) {
          let o = this.De(t, i.connectionToken);
          if (this.Re(s))
            return (
              this.u.log(
                e.Debug,
          ...
          switch (t) {
            case F.WebSockets:
              ...
              return new V(
                ...
                this.Zt,
                this.u,
                this.ne.logMessageContent,
                this.ne.WebSocket,
                this.ne.headers || {},
              );
            case F.ServerSentEvents:
              if (!this.ne.EventSource)
                throw new Error(
                  "'EventSource' is not supported in your environment.",
                );
              return new z(this.$, this.$.te, this.u, this.ne);
            case F.LongPolling:
              return new J(this.$, this.u, this.ne);
            default:
        ...
        Pe(t, e) {
          return (
            ...
            this.features.reconnect
              ...
              : (this.transport.onclose = (t) => this.Se(t)),
        ...
        xe(t, s, i, n) {
          ...
          if (
            (r === F.WebSockets && !this.ne.WebSocket) ||
            (r === F.ServerSentEvents && !this.ne.EventSource)
          )
            return (
              this.u.log(
                e.Debug,
        ...
        _e(t) {
          ...
          return (
            s.has("negotiateVersion") ||
              s.append("negotiateVersion", this.ve.toString()),
            s.has("useStatefulReconnect")
              ? "true" === s.get("useStatefulReconnect") && (this.ne.He = !0)
              : !0 === this.ne.He && s.append("useStatefulReconnect", "true"),
            (e.search = s.toString()),
            e.toString()
          );
        }
      ...
      class G {
        ...
        send(t) {
          return (this.We(t), this.qe || (this.qe = new Q()), this.qe.promise);
        }
        stop() {
          return ((this.Le = !1), this.Ne.resolve(), this.Me);
        }
        We(t) {
          if (this.Ue.length && typeof this.Ue[0] != typeof t)
            throw new Error(
              `Expected data to be of type ${typeof this.Ue} but was of type ${typeof t}`,
            );
          (this.Ue.push(t), this.Ne.resolve());
        }
        async je() {
          for (;;) {
            if ((await this.Ne.promise, !this.Le)) {
              this.qe && this.qe.reject("Connection stopped.");
              break;
            }
            this.Ne = new Q();
            const t = this.qe;
            this.qe = void 0;
            const e =
              "string" == typeof this.Ue[0] ? this.Ue.join("") : G.Oe(this.Ue);
            this.Ue.length = 0;
            try {
              (await this.Ae.send(e), t.resolve());
            } catch (e) {
              t.reject(e);
            }
          }
      ...
      class Q {
        constructor() {
          this.promise = new Promise((t, e) => ([this.j, this.Fe] = [t, e]));
        }
        resolve() {
          this.j();
        }
      ...
      class Y {
        ...
        U(t) {
          (this.Ve(t.target, "Invalid payload for Invocation message."),
        ...
        Be(t) {
          if (
            (this.Ve(t.invocationId, "Invalid payload for StreamItem message."),
            void 0 === t.item)
          )
        ...
        Xe(t) {
          ...
          (!t.result &&
            t.error &&
            this.Ve(t.error, "Invalid payload for Completion message."),
            this.Ve(t.invocationId, "Invalid payload for Completion message."));
        }
        Je(t) {
      ...
      class tt {
        ...
        withKeepAliveInterval(t) {
          return (w.isRequired(t, "milliseconds"), (this.Ge = t), this);
        }
        withStatefulReconnect(t) {
          return (
            void 0 === this.httpConnectionOptions &&
              (this.httpConnectionOptions = {}),
            (this.httpConnectionOptions.He = !0),
