...
function filterTab(name) {
  ...
  function applyFilter() {
    ...
    items.forEach(item => {
      ...
      else if (currentFilter === 'unread') show = read === 'false';
    ...
    document.querySelectorAll('#notifList > div:not(.notif-item)').forEach(header => {
  ...
  function updateBadge() {
    ...
    const badge = document.querySelector('aside .bg-primary.text-white.text-\\[10px\\]');
